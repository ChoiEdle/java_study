...
public class BankMan {
	...
	public void check(AccountPaperVo accountPaper) {
		for(int i=0; i<accountList.length; i++) {
			boolean checkName = accountList[i].getName().equals(accountPaper.getName());
			boolean checkNumber = accountList[i].getAccountNumber().equals(accountPaper.getAccountNumber());
			boolean checkPassword = accountList[i].getPassword().equals(accountPaper.getPassword());
			boolean checkMoney = accountList[i].getBalance()>=accountPaper.getMoney();
			if(checkName && checkNumber && checkPassword && checkMoney) {
