...
public class OpLogicTest {
	...
	public static void main(String[] args) {
		...
		System.out.println((a < b) && (a == 10));	//false		Shortcut
		System.out.println((a < b) && (b == 10));	//false		Shortcut

		//OR(||) : 두 개의 항의 결과중 하나라도 true이면 실행결과가 true
		System.out.println((a > b) || (a == 10));	//true		Shortcut
		System.out.println((a > b) || (b == 10));	//true		Shortcut
		System.out.println((a < b) || (a == 10));	//true
		System.out.println((a < b) || (b == 10));	//false
