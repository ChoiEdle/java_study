...
public class MethodCase {
	...
	//리턴타입 X, 매개변수 O : 매개변수의 타입과 갯수에 따라 메소드 오버로딩(Overloading) 구현이 가능함
	...
	//리턴타입 O, 매개변수 O : 매개변수의 타입과 갯수에 따라 메소드 오버로딩(Overloading) 구현이 가능함
	...
	public static void main(String[] args) {
		...
		mc.method1();
		int sum = mc.method2();			//이렇게 하면 mc.method2 값을 반복해서 사용할때 메모리 낭비를 방지함
